...
describe("matchUserDetailsWithPdv", () => {
  ...
  it("should concat all provided FamilyName", async () => {
    ...
    // deep clone mock PI
    const manyFamilyNamesPersonIdentity: PersonIdentityItem = JSON.parse(
      JSON.stringify(personIdentity)
    );
    ...
    const result = await matchUserDetailsWithPdv(
      pdvConfig,
      oAuthToken,
      manyFamilyNamesPersonIdentity,
      nino,
      mockLogger,
      mockMetricsHelper
    );
  ...
  it("should select only the first GivenName", async () => {
    ...
    // deep clone mock PI
    const manyGivenNamesPersonIdentity: PersonIdentityItem = JSON.parse(
      JSON.stringify(personIdentity)
    );
  ...
  it("should throw when GivenName is blank", async () => {
    // deep clone mock PI
    const blankFirstNamePersonIdentity: PersonIdentityItem = JSON.parse(
      JSON.stringify(personIdentity)
    );
  ...
  it("should throw when FamilyName is blank", async () => {
    // deep clone mock PI
    const blankGivenNamePersonIdentity: PersonIdentityItem = JSON.parse(
      JSON.stringify(personIdentity)
    );
  ...
  it("should throw when no value for name part is provided", async () => {
    // deep clone mock PI
    const blankNamePartPersonIdentity: PersonIdentityItem = JSON.parse(
      JSON.stringify(personIdentity)
    );
