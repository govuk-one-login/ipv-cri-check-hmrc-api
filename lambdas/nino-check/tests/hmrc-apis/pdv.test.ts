...
const mockInput = [pdvConfig, oAuthToken, personIdentity, nino, mockLogger, mockMetricsHelper] as const;
...
describe("matchUserDetailsWithPdv", () => {
  ...
  it("should throw when GivenName is blank", async () => {
    ...
    await expect(async () =>
      matchUserDetailsWithPdv(pdvConfig, oAuthToken, blankFirstNamePersonIdentity, nino, mockLogger, mockMetricsHelper)
  ...
  it("should throw when FamilyName is blank", async () => {
    ...
    await expect(async () =>
      matchUserDetailsWithPdv(pdvConfig, oAuthToken, blankGivenNamePersonIdentity, nino, mockLogger, mockMetricsHelper)
  ...
  it("should throw when no value for name part is provided", async () => {
    ...
    await expect(async () =>
      matchUserDetailsWithPdv(pdvConfig, oAuthToken, blankNamePartPersonIdentity, nino, mockLogger, mockMetricsHelper)
    ).rejects.toThrow(new Error("First Name is blank"));
  });
});
